"""
python manager.py runjob -m stat/daily -a member | food | site -p 2019-01-20
"""
...
class JobTask():
    ...
    def run(self, params):
        ...
        date_from = date + " 00:00:00"      # 查询时间开始
        date_to = date + " 23:59:59"        # 查询时间结束
    ...
    def statMember(self, params):
        ...
        if not member_list:                                 # 如果会员比较多，可以多次运行
