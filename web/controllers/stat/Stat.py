...
def index():
    ...
    return i_render_template( "stat/index.html",resp_data )
...
def food():
    ...
    return i_render_template( "stat/food.html",resp_data  )
...
def memebr():
    ...
    return i_render_template( "stat/member.html",resp_data  )
...
def share():
    ...
    return i_render_template( "stat/share.html",resp_data  )
