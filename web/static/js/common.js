...
var common_ops = {
    ...
    buildUrl:function (path, params) {
        var url = "" + path;
        var _paramUrl = "";
        //params是个字典形式{a:"b",c:"d"}，最终输出a=b&c=d格式
        if(params){
    ...
    //图片链接拼装,接收来自layout_main.html传入的后端配置
    buildPicUrl:function (img_key) {
        var domain = $(".hidde_layout_wrap input[name=domain]").val()
        var prefix_url = $(".hidde_layout_wrap input[name=prefix_url]").val()
